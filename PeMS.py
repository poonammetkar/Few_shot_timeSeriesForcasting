...
DISTRICT = 10
YEAR = 2023
MAIN_DIR = r'C:\Users\poonammetkar\Documents\one_shot_time_series_forecast_tinker'
FEATURES = ['timestamp', 'station', 'total_flow']
'''____________________________________________________________'''
    ...
    def create_csv_from_gv(self):
        ...
        def create_csv_from_pems_txt_gz(file):
            ...
            df = pd.read_csv(file,
                             ...
                             usecols=sorted([COLUMN_DICT[i] for i in self.__features]),
                             engine='python')
            file_name = file.name
